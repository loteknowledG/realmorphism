      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-8">
        ...
        <section className="grid gap-6">
          ...
          <Card className="overflow-hidden border-border/70 bg-card/90 backdrop-blur">
            <CardHeader className="items-start">
              <div className="space-y-2">
                <CardTitle>Operational component gallery</CardTitle>
                <CardDescription>
                  Shared motion layer (<code className="text-xs">.realmorphism-action</code>) on
                  shadcn primitives — Echo Mirage operational palette.
                </CardDescription>
              </div>
              <Badge variant="outline" className="rounded-full px-3 py-1 font-mono text-[10px]">
                theme-realmorphism
              </Badge>
            </CardHeader>

            <CardContent>
              <div className="theme-realmorphism rounded-[var(--radius)] border border-[var(--realmorphism-face-border)] p-5">
                <div className="mb-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                  {[
                    ...
                    <div
                      key={label}
                      className="rounded-[var(--radius)] border border-[var(--realmorphism-face-border)] bg-[var(--realmorphism-host-raised)] p-3"
                    >
                      <div
                        className="mb-2 h-12 border border-[var(--realmorphism-face-border)]"
                        style={{ background: color }}
                      />
                      <div className="font-mono text-xs text-[var(--realmorphism-ink-on-face)]">
                        {label}
                      </div>
                ...
                <div className="grid gap-6 lg:grid-cols-2">
                  <div className="space-y-4">
                    ...
                    <div className="flex flex-wrap gap-3">
                      <button
                        type="button"
                        className="realmorphism-action px-5 py-3 font-mono text-sm"
                      >
                        Commit
                      </button>
                      <button
                      ...
                      <button
                        type="button"
                        className="realmorphism-action is-amber px-5 py-3 font-mono text-sm"
                      >
                        Caution
                      </button>
                      <button
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="ops-unit">Unit callback</Label>
                      <Input
                        id="ops-unit"
                        placeholder="4B // water through ceiling"
                        defaultValue=""
                      />
                    </div>
                    <div className="flex items-center gap-3">
                      <Switch
                        id="ops-alert"
                        checked={opsAlert}
                        onCheckedChange={setOpsAlert}
                        aria-label="Emergency alert lane"
                      />
                      <Label htmlFor="ops-alert">Emergency alert lane</Label>
                    </div>
                    <div className="flex items-center gap-3">
                      <Checkbox
                        id="ops-ack"
                        ...
                        aria-label="Acknowledge draft ticket"
                      />
                      <Label htmlFor="ops-ack">Acknowledge draft ticket</Label>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <CardFooter className="justify-between border-t border-border/70 pt-6 text-sm text-muted-foreground">
              <span>Installable via shadcn registry theme + base kit.</span>
              <span>Motion = affordance</span>
            </CardFooter>
          </Card>
